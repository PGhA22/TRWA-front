export default function SignIn_withGoogle(params) {
  return (
    <div className="flex items-center justify-center">
      <button className="text-black active:text-[#000080] flex items-center justify-center gap-2 py-1 px-2 h-8 rounded-[10px] bg-white border border-gray-300 hover:shadow-sm shadow-blue-400 transition-shadow cursor-pointer">
        <svg
          version="1.1"
